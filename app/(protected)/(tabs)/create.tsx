...
interface TaskForm {
  ...
  dueDate: string;
  assigned_to: string[]; // Added to match TasksScreen expectations
}
...
export default function CreateTaskScreen() {
  ...
  const [formData, setFormData] = useState<TaskForm>({
    ...
    priority: 'Medium',
    dueDate: '',
    assigned_to: user ? [user.id] : [], // Assign to current user by default
  });
  ...
  const getCategoryIcon = (category: string) => {
    ...
    // @ts-ignore
    return Platform.OS === 'ios' ? iconMap[category] : `${iconMap[category]}-outline`;
  };
  ...
  const handleCreateTask = async () => {
    ...
    try {
      await addTask({
        ...
        // @ts-ignore
        assigned_to: [user.id], // Ensure assigned to current user
      });
  ...
  return (
    <SafeAreaView style={styles.safeArea}>
            ...
            <View style={styles.form}>
                ...
                <Animated.View style={animatedStyle}>
                  ...
                  >
                    <View style={styles.selectorContent}>
                      <Ionicons name={getCategoryIcon(formData.category)} size={22} color="#2563EB" />
              ...
              <View style={styles.inputContainer}>
                ...
                <DateTimePickerModal
                  ...
                  accentColor="#2563EB"
                  textColor="#1F2937"
                  accessibilityLabel="Due date picker modal"
                />
              </View>
      ...
      <Animated.View style={[animatedStyle, styles.floatingButton, { bottom: 30 + insets.bottom }]}>
        <TouchableOpacity
          ...
          onPressOut={handlePressOut}
          disabled={loading}
          accessibilityLabel="Save task floating button"
        >
          <Ionicons
            name={Platform.OS === 'ios' ? 'checkmark' : 'checkmark-outline'}
            size={28}
            color="#FFFFFF"
          />
        </TouchableOpacity>
